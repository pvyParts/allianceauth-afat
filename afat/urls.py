...
urlpatterns = [
    ...
    # stats main page
    url(r"^statistic/$", views.statistics.stats, name="stats"),
    url(r"^statistic/(?P<year>[0-9]+)/$", views.statistics.stats, name="stats"),
    # stats corp
    url(r"^statistic/corporation/$", views.statistics.stats_corp, name="stats_corp"),
    url(
    ...
    # stats char
    url(r"^statistic/character/$", views.statistics.stats_char, name="stats_char"),
    url(
    ...
    # stats alliance
    url(r"^statistic/alliance/$", views.statistics.stats_alliance, name="stats_ally"),
    url(
    ...
    # fat links
    url(r"^links/$", views.fatlinks.links, name="links"),
    url(r"^links/(?P<year>[0-9]+)/$", views.fatlinks.links, name="links"),
    url(
    ...
    url(
        r"^links/create/esifat/$", views.fatlinks.create_esi_fat, name="create_esi_fat"
    ),
    url(
        r"^links/create/click/$",
        views.fatlinks.link_create_click,
        name="link_create_click",
    ),
    url(r"^links/add/$", views.fatlinks.link_add, name="link_add"),
    url(r"^links/edit/$", views.fatlinks.link_edit, name="link_edit"),
    url(
    ...
    url(r"^links/del/$", views.fatlinks.del_link, name="link_delete"),
    url(
    ...
    url(r"^ajax/links/get_fatlinks/$", views.fatlinks.links_data, name="links_data"),
    url(
